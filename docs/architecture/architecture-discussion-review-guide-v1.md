# IB Camp Architecture Discussion Review Guide v1
...
The goal is to decide whether the recommended architecture is the right fit for the approved IB Camp product model.
