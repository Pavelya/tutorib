# IB Camp Matching And Ranking Architecture v1
...
This document defines how IB Camp should turn a student's need into a ranked set of tutor fits.
...
IB Camp should start with a deterministic, explainable, Postgres-backed matching system built around:
...
IB Camp should implement matching as a domain-owned ranking system, not as a generic search layer.
