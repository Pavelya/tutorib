# IB Camp Query Performance SLOs And Scaling Thresholds v1
...
IB Camp should use a **read-model-first, cache-aware, invalidation-driven query architecture** with explicit latency targets.
...
IB Camp should treat query speed as a measurable product promise.
