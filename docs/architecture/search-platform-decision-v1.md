# IB Camp Search Platform Decision v1
...
- should IB Camp use Algolia from the beginning, or keep search on Postgres first and add Algolia only if real need appears later
...
## 12. Recommended Direction For IB Camp
...
IB Camp should **not** plug in Algolia from the very beginning by default.
