# IB Camp Structured Data Map v1
...
This document defines how structured data should be used across IB Camp's public pages.
...
If the page does not clearly support a schema type with visible content, IB Camp should not emit that schema type.
...
IB Camp should use structured data as a conservative clarity layer.
