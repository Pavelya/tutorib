# IB Camp Auth And Authorization Matrix v1
...
This document defines who can access what in IB Camp.
...
IB Camp should use a four-layer access model:
...
## 19. Recommended Next Data Artifacts

After this matrix, the strongest next docs are:
...
IB Camp should use a conservative, layered authorization system:
