# IB Camp Data Retention And Erasure Field Map v1
...
IB Camp already has a privacy architecture and a schema outline.
...
IB Camp should use a **purpose-limited, field-aware retention model**:
...
- do not store raw card or bank details in IB Camp tables
...
- remember that IB Camp can stop referencing external media, but may not control provider-side deletion
...
IB Camp should implement retention as a field-aware lifecycle system.
