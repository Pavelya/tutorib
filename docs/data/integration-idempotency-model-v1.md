# IB Camp Integration Idempotency Model v1
...
IB Camp should use a **durable idempotency model** based on:
...
IB Camp should use a small number of explicit key families.
...
## 9. Operation-Specific Rules For IB Camp
...
IB Camp should treat idempotency as a shared system contract, not as an ad hoc payment trick.
