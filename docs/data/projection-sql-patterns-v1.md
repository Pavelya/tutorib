# IB Camp Projection SQL Patterns v1
...
For IB Camp, this remains a later optimization tool, not the default phase 1 shape.
...
If IB Camp later exports public discovery data to Algolia or another external index, the SQL contract should be:
...
IB Camp should implement projections with a small, consistent SQL pattern family:
