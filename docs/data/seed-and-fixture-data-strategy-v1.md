# IB Camp Seed And Fixture Data Strategy v1
...
IB Camp should use a three-layer non-production data model:
...
IB Camp should treat seed content as a few explicit families rather than one giant SQL blob.
...
This is especially important for IB Camp because public tutor browse and internal matching speed are product-critical surfaces.
...
IB Camp should follow that strictly:
...
IB Camp should explicitly support optional scale fixtures for hot paths such as:
...
IB Camp should keep non-production data boring, explicit, and reusable:
