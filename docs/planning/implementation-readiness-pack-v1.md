# IB Camp Implementation Readiness Pack v1
...
This document exists to turn the approved IB Camp design system and screen work into an implementation-ready product pack.
